...
<body>
  ...
  <div id="app" :class="{ 'reader-mode-bg': readerMode}">
    ...
    <div :class="{'topnav': true, 'reader-mode': readerMode}" @mouseleave="openPreviousPastesMenu =false">
      ...
      <span class="tagline">"A client side encrypted PasteBin based on <a href="https://github.com/Tygs/0bin" target="_blank">0bin</a>"<br><span>All pastes are AES256 encrypted, we cannot know
          what you paste...</span>
      </span>
