    ...
    <div class="paste-options-res">
      <div class="btn-group">
        ...
        <a class="btn btn-primary btc-tip-address"
          href="bitcoin:{{ paste.btc_tip_address or '1CaGYVKLmtmBfFghxXNLpXTsYJXUsx1iub' }}">
          {{ paste.btc_tip_address or '1CaGYVKLmtmBfFghxXNLpXTsYJXUsx1iub'}}
        </a>
      ...
      <div class="paste-options">
        ...
        <div class="input-group mb-3">
          ...
          <input type="text" class="form-control paste-btc-tip-address" name="paste-btc-tip-address"
            placeholder="Put a BTC address to ask for a tip. Leave it empty to let us use ours."
